    ...
    return (
      <div>
        ...
        <ul className="hoglist">
          <BabyHog eyeColor = {this.state.eyeColor} info = {offspring[0]}/>
          <BabyHog eyeColor = {this.state.eyeColor} info = {offspring[1]}/>
          <BabyHog eyeColor = {this.state.eyeColor} info = {offspring[2]}/>
        </ul>
